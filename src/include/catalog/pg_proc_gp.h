...
DATA(insert OID = 6998 ( gp_create_restore_point  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 16 "25" _null_ _null_ _null_ _null_ gp_create_restore_point _null_ _null_ _null_ n a ));
